...
SRC_URI:append:tinker-v-rzfive = " \
    ...
    file://v5-0001-sbi-sbi_pmu-Improve-sbi_pmu_init-error-handling.patch \
    file://v5-0002-sbi-sbi_pmu-Add-hw_counter_filter_mode-to-pmu-dev.patch \
    file://v5-0003-platform-include-andes45-Add-PMU-related-CSR-defi.patch \
    file://v5-0004-platform-andes-Add-Andes-custom-PMU-support.patch \
    file://v5-0005-platform-andes-Enable-Andes-PMU-for-AE350.patch \
    file://v5-0006-platform-rzfive-Enable-Andes-PMU-for-RZ-Five.patch \
    file://v5-0007-lib-utils-fdt_fixup-Add-fdt_add_pmu_mappings-help.patch \
    file://v5-0008-platform-andes-Factor-out-is_andes-helper.patch \
    file://v5-0009-platform-andes-Implement-andes_fdt_add_pmu_mappin.patch \
    file://v5-0010-docs-pmu-Add-Andes-PMU-node-example.patch \
    file://v5-0011-DROP-disable-SEMIHOSTING.patch \
    file://v5-0012-DROP-Print-entries-at-boot-time.patch \
"
